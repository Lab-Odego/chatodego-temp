	...
	// base case
        ...
        while(true) {
            ...
            if (!isPageExist) {
                ...
                for (let place of places) {
                    fs.appendFileSync("./places1.json", JSON.stringify(place));
                    fs.appendFileSync("./places1.json", ",\n\t");
                }
                break;
            }
            // page가 있는 경우
...
async function doPuppeteer() {
    ...
    try {
        ...
        //X1=963100 Y1=448600
        //X2=978000 Y2=436000
        //Xmean=970550 Ymean=442300
        await divide(page, [963100, 448600], [978000, 436000], 7);
    }
    catch (err) {
        console.log(err);
        console.log(path);
...
doPuppeteer();
// https://map.kakao.com/?panoid=1011393059&pan=285.0&tilt=0.0&zoom=-2&map_type=TYPE_MAP&map_hybrid=false&map_attribute=ROADVIEW%3Cbr%3E&q=%EA%B2%BD%EA%B8%B0%EB%8F%84%20%EA%B4%91%EB%AA%85%EC%8B%9C%20%EA%B4%91%EB%AA%855%EB%8F%99%20276-72&urlX=467052&urlY=1104790&urlLevel=3
